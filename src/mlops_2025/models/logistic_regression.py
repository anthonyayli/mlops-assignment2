...
def build_parser() -> argparse.ArgumentParser:
    ...
    """
    parser = argparse.ArgumentParser(description="Train Logistic Regression model on Titanic dataset")
    parser.add_argument(
        "--train-features",
        required=True,
    ...
    parser.add_argument(
        "--model-output",
        default="models/logistic_regression.pkl",
...
def main():
    """Main function to run the Logistic Regression model from command line."""
